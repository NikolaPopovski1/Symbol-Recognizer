namespace SymbolRecogniser.NeuralNetwork
{
    ...
    {
        public const int NUM_OF_LAYERS = 3; // input layer + hidden layer/s + output layer
        ...
        public const int MIN_RANDOM_WEIGHT = -1; // random weight range
        public const int MAX_RANDOM_WEIGHT = 1; // random weight range
        public const int MIN_RANDOM_BIAS = -1; // random bias range
        public const int MAX_RANDOM_BIAS = 1; // random bias range
